...
public class Day16
{
  ...
  public static Pair<Set<Point>, Long> astar(Maze maze)
  {
    ...
    State startState = new State(maze.start, Vector.EAST);
    Long endCost = null;
    ...
    if (debug)
    {
      ...
      for(int x = 0; x < maze.width; x++)
      {
        ...
        {
          c += maze.getType(Point.makeXYPoint(x, y)) == SpaceType.EMPTY ? 4 : 0;
        }
      }
  ...
  public record State(Point point, Vector direction)
  {
    @Override
